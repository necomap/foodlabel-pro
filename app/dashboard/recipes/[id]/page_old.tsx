  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        else { toast.error('レシピが見つかりません'); router.push('/dashboard/recipes'); }
      ...
      {recipe.bakingConditions && recipe.bakingConditions.length > 0 && (
        <div className="card">
          ...
          <div className="space-y-2">
            {(Array.isArray(recipe.bakingConditions) ? recipe.bakingConditions : JSON.parse(recipe.bakingConditions as string)).map((step: BakingStep, idx: number) => (
