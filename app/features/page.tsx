...
const FEATURES = [
  ...
  },
  {
    ...
    items: ['A4シール用紙への複数面付け印刷（フチあり）', 'ラベルプリンター対応（対応機種はヘルプ参照）', '製造日・賞味期限の自動計算', '店舗情報の自動挿入', 'フォントサイズ調整', '印刷プレビュー機能'],
  },
  {
    icon: Tag,
    title: '食材マスタ管理',
  ...
  },
  {
    ...
    title: '店舗・設定管理',
    desc: '複数店舗の情報を管理できます。',
    items: ['複数店舗の登録・管理（スタンダード3件・プロ10件）', '店舗ごとの住所・電話番号設定', 'レシピカテゴリのカスタマイズ', 'プロフィール情報の編集'],
  },
  {
    icon: ShieldCheck,
