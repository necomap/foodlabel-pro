...
const FAQS = [
  ...
  { q: 'どんなプリンターで印刷できますか？', a: 'ラベルプリンター（幅・高さをmm単位で指定、内容に応じた自動文字縮小つき）とA4用紙（複数面付け印刷）の両方に対応しています。バーコード、識別マーク（プラ・紙などのリサイクルマーク）、ロゴ・QRコードの印字にも対応し、無定長（連続）ロール紙でも固定サイズのラベルをきれいに印刷できます。' },
